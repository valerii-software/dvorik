...
DEMO = [
    ('Павел', 'Тарасов', 'pavel@dvorik.local', 'Санкт-Петербург', 'СПбГУ, филфак.', 'Программирование, восточные единоборства, чтение.'),
    ('Анна', 'Иванова', 'anna@dvorik.local', 'Москва', 'МГУ, журфак, 3 курс.', 'Музыка, путешествия, фотография.'),
    ('Михаил', 'Петров', 'mikhail@dvorik.local', 'Новосибирск', 'НГУ, физфак.', 'Футбол, кино, программирование.'),
    ('Екатерина', 'Смирнова', 'katya@dvorik.local', 'Казань', 'КФУ, экономика.', 'Книги, йога, рисование.'),
    ('Дмитрий', 'Кузнецов', 'dmitry@dvorik.local', 'Екатеринбург', 'УрФУ, ИРИТ-РТФ.', 'Игры, аниме, гитара.'),
    ('Ольга', 'Соколова', 'olga@dvorik.local', 'Нижний Новгород', 'ННГУ, биофак.', 'Природа, велосипед, кулинария.'),
]
